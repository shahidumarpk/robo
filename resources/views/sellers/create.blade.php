...
.kv-reqd {
    ...
    <div class="box box-info">
            ...
            <form class="form-horizontal" action="{!! url('/sellers'); !!}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body" >
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="companyname" name="companyname" placeholder="Company Name" autocomplete="off" require >
                        @if ($errors->has('fname'))
                            <span class="text-red">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="companyregno" name="companyregno" placeholder="Company Registration No." autocomplete="off" require >
                        @if ($errors->has('fname'))
                            <span class="text-red">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="businessname" name="businessname" placeholder="Business Name" autocomplete="off" require >
                        @if ($errors->has('fname'))
                            <span class="text-red">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="businessnameregno" name="businessnameregno" placeholder="Business Name Registration No." autocomplete="off" require >
                        @if ($errors->has('fname'))
                            <span class="text-red">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="taxidentificationno" name="taxidentificationno" placeholder="Tax Identification No." autocomplete="off" require >
                        @if ($errors->has('fname'))
                            <span class="text-red">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="phonenumber" name="phonenumber" placeholder="Business Phone Number" value="{{ old('phonenumber') }}" autocomplete="off" require>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="facsimileno" name="facsimileno" placeholder="Facsimile No." value="{{ old('phonenumber') }}" autocomplete="off" require>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" value="{{ old('phonenumber') }}" autocomplete="off" require>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="website" name="website" placeholder="Website Address" autocomplete="off" require>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="province" name="province" placeholder="Province" required >
                            <option value="1" selected>Province 1</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="llg" name="llg" placeholder="LLG" required >
                            <option value="1" selected>LLG 1</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="ward" name="ward" placeholder="Ward" required >
                            <option value="1" selected>Ward 1</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="streetvillage" name="streetvillage" placeholder="Street/Village" required >
                            <option value="1" selected>Street/Village 1</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="pobox" name="pobox" placeholder="P O Box" autocomplete="off" require>
                        @if ($errors->has('pobox'))
                            <span class="text-red">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" id="postoffice" name="postoffice" placeholder="Post Office" required >
                            <option value="1" selected>Post Office 1</option>
