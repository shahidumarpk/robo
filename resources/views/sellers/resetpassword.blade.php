...
<div class="col-md-6 col-md-offset-3">
    <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Reset Password > James Bond (Lego Shop)</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{action('SellerController@update', $id)}}" method="post" autocomplete="off">
            @csrf
            ...
            <input name="resetpassword" type="hidden" value="1">
              ...
              <div class="box-footer">
                <a href="{!! url('/sellers'); !!}" class="btn btn-default">Cancel</a>
