            ...
            @if(count($users) > 0)
              <table id="example1" class="display responsive nowrap" style="width:100%">
                ...
                @foreach($users as $user)
                  <tr>
                    <td>G001</td>
                    <td  data-toggle="modal" data-target="#MarkupModal">Security Chain Gate</td>
                    <td>5.5</td>
                    <td>2.5</td>
                    <td>5.1</td>
                    <td>R 25.50</td>
                  ...
                  <tr>
                      <td>G001</td>
                      <td  data-toggle="modal" data-target="#MarkupModal">DELUX Gate</td>
                      <td>6.5</td>
                      <td>3.5</td>
                      <td>4.1</td>
                      <td>R 15.50</td>
                    ...
                    <tr>
                        <td>G001</td>
                        <td data-toggle="modal" data-target="#MarkupModal">TRELLES Gate</td>
                        <td>8.5</td>
                        <td>9.5</td>
                        <td>2.1</td>
                        <td>R 45.50</td>
          ...
          <div class="modal-body">
            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="quantity">Total Surface</label>
                ...
                <div class="form-group">
                  <label for="quantity">Rate per meter</label>
              ...
              <div class="modal-body">
                ...
                <form role="form">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="name">Product Name</label>
                      <input type="text" value="DELUX Gate" class="form-control" id="name" placeholder="Enter Name">
                    </div>
                    <div class="form-group">
                      <label for="code">Circumference</label>
